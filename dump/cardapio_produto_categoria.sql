...
CREATE TABLE `produto_categoria` (
  ...
  CONSTRAINT `produto_categoria_ibfk_1` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id`) ON DELETE CASCADE,
  CONSTRAINT `produto_categoria_ibfk_2` FOREIGN KEY (`id_categoria`) REFERENCES `categoria` (`id`) ON DELETE CASCADE
...
INSERT INTO `produto_categoria` VALUES (7,7,5),(8,8,5),(9,9,6),(10,10,6),(11,11,7);
